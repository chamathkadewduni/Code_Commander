...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT sa.id,topic,city,district,medium,type,description,status FROM student_ad sa JOIN city c ON c.id=sa.city_id WHERE sa.id = '$id'";
...
<body>
    ...
    <form action="student_profile.php" class="form-group">
