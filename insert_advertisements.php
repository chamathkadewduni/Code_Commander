...
?>
    <div class="container" onclick="hideSuggestions()">
        <h2 class="mt-3">Post Your Class Advertisement</h2>
        <br>
        <form id="insertAdvertisement" action="insert_advertisements_db.php" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control-radio" type="radio" name="classType" id="type_group" value="Group" required>
                &nbsp;
                <label for="type_group">Group </label>
                &nbsp; &nbsp; &nbsp;
                <input class="form-control-radio" type="radio" name="classType" id="type_individual" value="Individual" required>
                &nbsp;
            ...
            <div class="form-group">
                ...
                <input class="form-control-radio" type="radio" name="rateType" id="type_hourly" value="Hourly" required>
                &nbsp;
                <label for="type_hourly">Hourly </label>
                &nbsp; &nbsp; &nbsp;
                <input class="form-control-radio" type="radio" name="rateType" id="type_daily" value="Daily" required>
                &nbsp;
                <label for="type_daily">Daily </label>
                &nbsp; &nbsp; &nbsp;
                <input class="form-control-radio" type="radio" name="rateType" id="type_monthly" value="Monthly" required>
                &nbsp;
